<template>
  <a-modal
    ...
    <a-spin :spinning="confirmLoading">
      ...
      <!--    <a-input v-decorator="[ 'dataType', validatorRules.dataType]" placeholder="请输入数据类型"></a-input>  -->
          <j-dict-select-tag :triggerChange="true"   v-decorator="['dataType', validatorRules.dataType]" placeholder="请输入地址类型"  dictCode="d_type"/>
        </a-form-item>
  ...
  <!--        <a-input v-decorator="[ 'addressType', validatorRules.addressType]" placeholder="请输入地址类型"></a-input>  -->
