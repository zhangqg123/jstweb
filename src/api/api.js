...
const getCatTargetList = (params)=>getAction("/jst/jstZcTarget/list",params);
const multipleRead = (params)=>getAction("/jst/jstZcDev/handleRead",params);
const readClose = (params)=>getAction("/jst/jstZcDev/readClose",params);
const readAmq = (params)=>getAction("/jst/jstZcDev/readAmq",params);
